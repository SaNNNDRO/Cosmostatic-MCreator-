...
public class CosmostaticModBlockEntities {
	...
	public static final RegistryObject<BlockEntityType<?>> SPACE_WORKBENCH = register("space_workbench", CosmostaticModBlocks.SPACE_WORKBENCH, SpaceWorkbenchBlockEntity::new);
