 ...
 *
 */
package net.mcreator.cosmostatic;
...
@Mod("cosmostatic")
public class CosmostaticMod {
	public static final Logger LOGGER = LogManager.getLogger(CosmostaticMod.class);
	public static final String MODID = "cosmostatic";
