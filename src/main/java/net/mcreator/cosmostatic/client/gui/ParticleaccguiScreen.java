...
public class ParticleaccguiScreen extends AbstractContainerScreen<ParticleaccguiMenu> {
	private final static HashMap<String, Object> guistate = ParticleaccguiMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public ParticleaccguiScreen(ParticleaccguiMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("cosmostatic:textures/screens/particleaccgui.png");
