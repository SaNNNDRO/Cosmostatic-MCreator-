...
public class ParticleacceleratorguiScreen extends AbstractContainerScreen<ParticleacceleratorguiMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("cosmostatic:textures/screens/particleacceleratorgui.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "DM Transducer", 51, 7, -12829636);
	}
