...
public class ParticleaccguiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ParticleaccguiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(CosmostaticModMenus.PARTICLEACCGUI.get(), id);
